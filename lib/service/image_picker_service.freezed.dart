...
ImagePickerModel _$ImagePickerModelFromJson(Map<String, dynamic> json) {
  return _ImagePickerModel.fromJson(json);
}
...
abstract class $ImagePickerModelCopyWith<$Res> {
  factory $ImagePickerModelCopyWith(
    ImagePickerModel value,
    $Res Function(ImagePickerModel) then,
...
abstract class _$$ImagePickerModelImplCopyWith<$Res>
    implements $ImagePickerModelCopyWith<$Res> {
  factory _$$ImagePickerModelImplCopyWith(
    _$ImagePickerModelImpl value,
...
class __$$ImagePickerModelImplCopyWithImpl<$Res>
  ...
  __$$ImagePickerModelImplCopyWithImpl(
    _$ImagePickerModelImpl _value,
...
class _$ImagePickerModelImpl implements _ImagePickerModel {
  ...
  factory _$ImagePickerModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$ImagePickerModelImplFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$ImagePickerModelImplToJson(this);
  }
}

abstract class _ImagePickerModel implements ImagePickerModel {
  factory _ImagePickerModel({
    final String? imageUrl,
    final String? fileName,
    final String? imagePath,
    final String? imageUUID,
  ...
  factory _ImagePickerModel.fromJson(Map<String, dynamic> json) =
      _$ImagePickerModelImpl.fromJson;
