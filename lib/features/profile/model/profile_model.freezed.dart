...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,createdAt,updatedAt,const DeepCollectionEquality().hash(deletedAt),username,dp,phone,countryCode,email,description,profileCompleted,activeStatus,violationCount,likeCount,profileLiked,totalLivery,points,usernameCtr,countryCodeCtr,phoneNoCtr,emailCtr,descriptionCtr]);

@override
String toString() {
  return 'ProfileModel(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt, username: $username, dp: $dp, phone: $phone, countryCode: $countryCode, email: $email, description: $description, profileCompleted: $profileCompleted, activeStatus: $activeStatus, violationCount: $violationCount, likeCount: $likeCount, profileLiked: $profileLiked, totalLivery: $totalLivery, points: $points, usernameCtr: $usernameCtr, countryCodeCtr: $countryCodeCtr, phoneNoCtr: $phoneNoCtr, emailCtr: $emailCtr, descriptionCtr: $descriptionCtr)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'ID')  int? id, @JsonKey(name: 'CreatedAt')  DateTime? createdAt, @JsonKey(name: 'UpdatedAt')  DateTime? updatedAt, @JsonKey(name: 'DeletedAt')  dynamic deletedAt,  String? username,  String? dp,  String? phone, @JsonKey(name: 'country_code')  String? countryCode,  String? email,  String? description, @JsonKey(name: 'profile_completed')  bool? profileCompleted, @JsonKey(name: 'active_status')  bool? activeStatus, @JsonKey(name: 'violation_count')  int? violationCount, @JsonKey(name: 'like_count')  int? likeCount, @JsonKey(name: 'profile_liked')  bool? profileLiked, @JsonKey(name: 'total_livery')  int? totalLivery,  int? points, @JsonKey(includeFromJson: false, includeToJson: false)  TextEditingController? usernameCtr, @JsonKey(includeFromJson: false, includeToJson: false)  TextEditingController? countryCodeCtr, @JsonKey(includeFromJson: false, includeToJson: false)  TextEditingController? phoneNoCtr, @JsonKey(includeFromJson: false, includeToJson: false)  TextEditingController? emailCtr, @JsonKey(includeFromJson: false, includeToJson: false)  TextEditingController? descriptionCtr)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProfileModel() when $default != null:
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.deletedAt,_that.username,_that.dp,_that.phone,_that.countryCode,_that.email,_that.description,_that.profileCompleted,_that.activeStatus,_that.violationCount,_that.likeCount,_that.profileLiked,_that.totalLivery,_that.points,_that.usernameCtr,_that.countryCodeCtr,_that.phoneNoCtr,_that.emailCtr,_that.descriptionCtr);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'ID')  int? id, @JsonKey(name: 'CreatedAt')  DateTime? createdAt, @JsonKey(name: 'UpdatedAt')  DateTime? updatedAt, @JsonKey(name: 'DeletedAt')  dynamic deletedAt,  String? username,  String? dp,  String? phone, @JsonKey(name: 'country_code')  String? countryCode,  String? email,  String? description, @JsonKey(name: 'profile_completed')  bool? profileCompleted, @JsonKey(name: 'active_status')  bool? activeStatus, @JsonKey(name: 'violation_count')  int? violationCount, @JsonKey(name: 'like_count')  int? likeCount, @JsonKey(name: 'profile_liked')  bool? profileLiked, @JsonKey(name: 'total_livery')  int? totalLivery,  int? points, @JsonKey(includeFromJson: false, includeToJson: false)  TextEditingController? usernameCtr, @JsonKey(includeFromJson: false, includeToJson: false)  TextEditingController? countryCodeCtr, @JsonKey(includeFromJson: false, includeToJson: false)  TextEditingController? phoneNoCtr, @JsonKey(includeFromJson: false, includeToJson: false)  TextEditingController? emailCtr, @JsonKey(includeFromJson: false, includeToJson: false)  TextEditingController? descriptionCtr)  $default,) {final _that = this;
switch (_that) {
case _ProfileModel():
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.deletedAt,_that.username,_that.dp,_that.phone,_that.countryCode,_that.email,_that.description,_that.profileCompleted,_that.activeStatus,_that.violationCount,_that.likeCount,_that.profileLiked,_that.totalLivery,_that.points,_that.usernameCtr,_that.countryCodeCtr,_that.phoneNoCtr,_that.emailCtr,_that.descriptionCtr);case _:
  throw StateError('Unexpected subclass');
