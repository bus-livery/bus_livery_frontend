...
class LoaderContainerWithMessage extends StatefulWidget {
  ...
  @override
  LoaderContainerWithMessageState createState() =>
      LoaderContainerWithMessageState();
}

class LoaderContainerWithMessageState extends State<LoaderContainerWithMessage>
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: WwText(text: widget.message, textAlign: TextAlign.center),
          ),
        ],
      ),
    );
